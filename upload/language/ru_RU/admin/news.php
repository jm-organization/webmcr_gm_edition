...
$lng = array(
	...
	'news_add_time_error' => 'Время указано неправильно.',
	...
	'news_title_is_null' => 'Заголовок новости пуст! Введите, пожалуйста, заголовок.',
	'news_field_name' => 'Название',
	'news_field_cat' => 'Категория',
	'news_field_date' => 'Запланировать новость',
	'news_field_d_ph' => 'Введите дату публекации новости',
	'news_field_comment_close' => 'Отложенное закрытие комментариев',
	'news_field_cc_ph' => 'Введите дату закрытия комментирования',
	'news_field_text' => 'Текст новости',
	'news_field_text_desc' => 'Для разделения страницы до кнопки "Читать далее", используйте тег {READMORE}',
	'news_field_hidden' => 'Скрыть новость',
