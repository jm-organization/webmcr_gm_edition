...
VALUES
  ...
  ('block_monitoring', 'a:2:{s:5:"order";i:3;s:17:"permissions_level";s:14:"sys_monitoring";}', 'Мониторинг', 'Блок вывода мониторинга', 'Magicmen & Qexy', 'http://www.jm-org.net/', 'admin@jm-org.net', '2.1.3', '', false),
