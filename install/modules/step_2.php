	...
	public function content()
	{
		...
		if ($_SERVER['REQUEST_METHOD'] == 'POST') {
			...
			if (!isset($this->methods[$method])) {
				$this->install->notify($this->lng['e_method'], $this->lng['e_msg'], 'install/?do=step_2');
			}
			...
			if (!$query) {
				$this->install->notify($this->lng['e_add_admin'], $this->lng['e_msg'], 'install/?do=step_2');
			}
			...
			if (!$query) {
				$this->install->notify($this->lng['e_add_economy'], $this->lng['e_msg'], 'install/?do=step_2');
			}
